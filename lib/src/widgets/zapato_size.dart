...
import 'package:shoesapp/src/pages/zapato_des_page.dart';
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              _ZapatoConSombra(),
              if (!this.fullScreen) _ZapatosTallas()
            ],
          ),
        ),
      ),
...
final zapatoModel = Provider.of<ZapatoModel>(context);
    ...
    return Padding(
      ...
      child: Stack(
        children: <Widget>[
          Positioned(bottom: 20, right: 0, child: _ZapatoZombra()),
...
class _ZapatoZombra extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
